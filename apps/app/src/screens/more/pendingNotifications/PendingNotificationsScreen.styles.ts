...
export const makeStyles = (t: Theme) => StyleSheet.create({
  ...
  deleteBtn:      { paddingHorizontal: 12, paddingVertical: 6, borderWidth: 1, borderColor: t.colors.semantic.error, borderRadius: t.radius.sm },
  deleteBtnText:  { fontSize: t.fontSize.sm, color: t.colors.semantic.error, fontWeight: t.fontWeight.semiBold },
